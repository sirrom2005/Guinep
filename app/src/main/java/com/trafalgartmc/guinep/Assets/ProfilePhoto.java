...
/**
 * Created by Rohan Morris on 8/30/2016.
 */
public class ProfilePhoto extends android.support.v7.widget.AppCompatImageView {
    ...
    public ProfilePhoto(Context context, AttributeSet attrs, int defStyle) {
