...
public class SpecialsDataParser {
    private static List<DataObject> mObj;

    public static List<DataObject> getSpecialsList(Context c) {
        if(mObj==null) {
            String jsonStr = Utility.readTextFile(c, Common.SPECIALS_FILE);
    ...
    public static void clearSpecialsData() {
        mObj = null;
    }
}
